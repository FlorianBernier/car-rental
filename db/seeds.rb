...
Car.create!(user: User.all.sample, brand: 'Mercedes-Benz', model: 'A-Class', year_of_production: Date.new(2020), address: 'Rennes', price_per_day: 80.0, comment: "Technologie de pointe et design raffiné, une voiture qui se démarque.")
